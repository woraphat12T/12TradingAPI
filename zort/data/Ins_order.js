...
const { orderMovement } = require('../db_orm/order/Ordermovement') ;
    ...
    try {
      ...
      const datalength=data2.length ;
        for(let i=0;i<datalength;i++){
            ...
            [createdatetimeString],[updatedatetime],[updatedatetimeString],[expiredate],[expiredateString],[receivedate],[receivedateString],[totalproductamount],[uniquenumber],[properties],[isDeposit],[statusprint]) 
            ...
            :value26,:value27,:value28,:value29,:value30,:value31,:value32,:value33,:value34,:value35,:value36,:value37,:value38,:value39,:value40,:value41,:value42,:value43,:value44,:value45,:value46,:value47,:value48,:value49,:value50,:value51,:value52,:value53)
      ...
      for(const list of orderMoment ){
        ...
        for(const listofdetail of detail){
          ...
          const ctstock = await Product.findAll({attributes:['stock'],where:{sku:listofdetail.sku}})
          const stocknow = ctstock[0].stock
          const stockIns = stocknow - listofdetail.number ;
      ...
      //   for(const listofdetail of detail){
      //     // console.log(listofdetail.sku)
      //     var itcode = listofdetail.sku
      //     var itcodeOnly = itcode.split('_')[0];
      //     var itsku = itcode.split('_')[1] ;
      //     // console.log(itsku)
      ...
      //       const listsku = restdata[0].type ;
      //       for(const listsk of listsku){
      //         // console.log(listsk.factor + listsk.unit)  
      //         // console.log(listofdetail.number + itsku) 
      //         if(itsku == listsk.unit){
      //           var convert_unit = listsk.factor ;
      //         }
      //       }
      //       console.log(convert_unit)
      //   }
      // }
      //M3
